...
public class HttpResponseInitializer {
     ...
     *
     * The response line follows the format:
     *
     ...
     * @return A formatted HTTP response line.
     */
    static String createResponseLine(String httpVersion, HttpResponseStatus serverResponse) {
