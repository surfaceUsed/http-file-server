...
/**
 * Exception class for handling errors related to invalid or malformed URLs in HTTP requests.
 * When this exception is thrown, an error message is created and will be processed by an HttpResponse object.
 */
public class HttpRequestURLException extends Exception implements ErrorMessageHandler {

    private final HttpMessage errorMessage;

    /**
     * Constructs a new HttpRequestURLException with the specified error message and HTTP response status.
     *
     ...
     */
    public HttpRequestURLException(String message, HttpResponseStatus httpResponseStatus) {
        super(message);
